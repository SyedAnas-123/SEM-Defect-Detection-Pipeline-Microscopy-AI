...
"""),
    ...
    nbf.v4.new_markdown_cell("## 2. Sanity Training Run"),
...
nb['cells'] = cells
notebook_path = os.path.join(os.path.dirname(__file__), 'notebooks', '18_exp16_yolo11m_p2_sanity.ipynb')
